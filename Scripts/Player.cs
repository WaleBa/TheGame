...
public partial class Player : CharacterBody2D
{
    ...
    public override void _PhysicsProcess(double delta)
	{
		...
		if(Position.DistanceTo(new Vector2(0,0)) > Global.MAX_DISTANCE_FROM_CENTRE * 9)
			Position = (Position - new Vector2(0,0)).Normalized() * Global.MAX_DISTANCE_FROM_CENTRE * 9;
